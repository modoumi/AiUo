...
{
    public static uint Hash32(string source, uint seed = 8848)
        => Hash32(Encoding.UTF8.GetBytes(source), seed);
    public static uint Hash32(ReadOnlySpan<byte> bytes, uint seed = 8848)
    {
